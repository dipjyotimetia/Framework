...
public class JyperionListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		// Need to change for testcases
		String file=System.getProperty("C:\\Research\\Framework\\Screenshots")+"\\"+"Screenshot"+(new Random().nextInt())+".png";
		try {
			DemoBaseClass.takeSnapShot(DemoBaseClass.getDriver(),file);
		} catch (Exception e) {
			e.printStackTrace();
		}
